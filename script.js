...
function setupHero() {
    ...
    // LÓGICA STRICTA: Si existe HERO_IDS, SOLO usamos eso.
    if (window.HERO_IDS && Array.isArray(window.HERO_IDS) && window.HERO_IDS.length > 0) {
        ...
        // Fallback solo si NO existe configuración
...
function setPlayerVideo(url, overlayText = null) {
    ...
    // ATRIBUTO CRÍTICO PARA EVITAR POPUPS
...
function setupEventListeners() {
    ...
    // ENLACES CORREGIDOS: Mediafire -> App, GitHub -> Web
