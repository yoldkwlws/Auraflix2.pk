...
let currentModalItem = null; // Elemento (peli o serie) actual en el modal
let currentSeasonIndex = 0;  // Temporada seleccionada actualmente
...
// IDs constantes para subida de fotos
...
// --- NUEVA LÓGICA DE SELECTOR DE TEMPORADAS (MODAL) ---
