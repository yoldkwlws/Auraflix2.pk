...
function showVipBlocker() {
    ...
    // Generamos el HTML del bloqueo con la clase semitransparente
    playerDiv.innerHTML = `
        <div class="video-container" style="position:relative;">
            <!-- Fondo oscuro de base -->
            <div style="width:100%; height:100%; position:absolute; top:0; left:0; background:#111;"></div>
            
            <!-- Overlay Transparente con contenido VIP -->
